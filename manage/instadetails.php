...
$selectdeal = mysql_query("select * from insta where id='$deal_id'") or die ("select * from insta where id='$deal_id'".mysql_error());
...
<title>Insta Deal Details</title>
</head>
...
<form action="" method="post" name="dealdetail">
  ...
  <div class="block" style="margin-bottom:20px;">
     <label><font size="+1">Instant Deal Details</font></label>
     </div>
  <div class="block" style="margin-bottom:20px;">
